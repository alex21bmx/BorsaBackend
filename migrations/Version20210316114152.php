 ...
 */
final class Version20210316114152 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE candidat (id INT AUTO_INCREMENT NOT NULL, usuari_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, cognoms VARCHAR(255) NOT NULL, telefon BIGINT NOT NULL, UNIQUE INDEX UNIQ_6AB5B4715F263030 (usuari_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE empresa (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, tipus VARCHAR(255) NOT NULL, logo VARCHAR(255) NOT NULL, correu VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE oferta (id INT AUTO_INCREMENT NOT NULL, categoria_id INT DEFAULT NULL, empresa_id INT DEFAULT NULL, titol VARCHAR(255) NOT NULL, descripcio VARCHAR(255) NOT NULL, data DATE NOT NULL, ubicacio VARCHAR(255) NOT NULL, estat VARCHAR(255) NOT NULL, INDEX IDX_7479C8F23397707A (categoria_id), INDEX IDX_7479C8F2521E1991 (empresa_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
