...
class Empresa extends \App\Entity\Empresa implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Empresa' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Empresa' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Empresa' . "\0" . 'tipus', '' . "\0" . 'App\\Entity\\Empresa' . "\0" . 'logo', '' . "\0" . 'App\\Entity\\Empresa' . "\0" . 'correu', '' . "\0" . 'App\\Entity\\Empresa' . "\0" . 'usuari'];
        }
     ...
     * {@inheritDoc}
     */
    public function getUsuari(): ?\App\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function setUsuari(\App\Entity\User $usuari): \App\Entity\Empresa
    {
